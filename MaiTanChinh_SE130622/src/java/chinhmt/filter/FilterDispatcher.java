...
HttpServletRequest req = (HttpServletRequest) request;
        ...
        String properties = "/chinhmt/properties/function.properties";
//        InputStream input = new FileInputStream("D:\\STUDY\\CN5\\PRJ321\\MaiTanChinh_SE130622\\src\\java\\chinhmt\\properties\\function.properties");
        try {
            ...
            if (resource.length() > 0) {
                for(Object funcKey: prop.keySet()){
                    if (resource.equals(funcKey)) {
                        url = prop.get(funcKey).toString();
                    }
                }
            }
            if (url != null) {
            ...
            log("FilterDispatcher _ IO: " + e.getMessage());
        } catch (Throwable t){
            log("FilterDispatcher _ Throwrable: " + t.getMessage());
        }
    }
