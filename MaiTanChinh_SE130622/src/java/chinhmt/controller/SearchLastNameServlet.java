...
public class SearchLastNameServlet extends HttpServlet {
    ...
    //private final String SHOW_RESULT_PAGE = "ShowSearcResultServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (session != null) {
                ...
                }// end if search value is not empty String
            } else {
                url = LOGIN_PAGE;
            }
    ...
    //<%= request.getParameter("txtSearchValue")%> của search.jsp chỗ điền searchValue
